      ...
      <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        >
          ...
          <div className="mt-5 flex justify-center">
            <input aria-label="Choose inventory photos" ref={inputRef} type="file" accept="image/jpeg,image/png,image/webp" multiple className="hidden" onChange={onInputChange} />
